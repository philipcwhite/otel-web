...
class Data:
    ...
    def create_tables(self):
        ...
        #create_metrics = 'CREATE TABLE IF NOT EXISTS metrics (ID INTEGER PRIMARY KEY, data TEXT NOT NULL);'
        #create_traces = 'CREATE TABLE IF NOT EXISTS traces (ID INTEGER PRIMARY KEY, data TEXT NOT NULL);'
        #create_logs = 'CREATE TABLE IF NOT EXISTS logs (ID INTEGER PRIMARY KEY, data TEXT NOT NULL);'
...
class Web:
    ...
    def index():
        ...
        return render_template('index.html', user = 'phil', index_content = content)
