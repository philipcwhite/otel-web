...
class Data:
    ...
    def get_metrics4(self):
        sql = "SELECT distinct json_extract(value, '$.resource.attributes') as attributes from metrics, json_tree(metrics.json, '$.resourceMetrics') where type='object';" 
    ...
    def get_metrics6(self):
        sql = "SELECT DISTINCT json_extract(value, '$.resource.attributes') as attributes from metrics, json_tree(metrics.json, '$.resourceMetrics') where type='object' and attributes is not NULL;"  
